...
[[nodiscard]] t_title_screen_tick_result_id TitleScreenTick(t_title_screen *const ts, const t_assets *const assets, const zgl::t_input_state *const input_state, zcl::t_v2_i screen_size, zcl::t_arena *const temp_arena);
